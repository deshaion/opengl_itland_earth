...
// PASTLWTR : 1.2
// File generated on 23.07.2005 17:31:08 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Documents and Settings\Vanya\Мои документы\Работа\ITland\ItlandWProj1.tlb (1)
// LIBID: {707E634E-E96C-4AF8-9F35-3B968239375C}
// LCID: 0
// Helpfile: 
// HelpString: ItlandWProj1 Library
// DepndLst: 
//   (1) v2.0 stdole, (C:\WINDOWS.0\system32\stdole2.tlb)
//   (2) v4.0 StdVCL, (C:\WINDOWS.0\system32\stdvcl40.dll)
// ************************************************************************ //
...
const
  ...
  ItlandWProj1MajorVersion = 1;
  ItlandWProj1MinorVersion = 0;

  LIBID_ItlandWProj1: TGUID = '{707E634E-E96C-4AF8-9F35-3B968239375C}';

  IID_IItlandW: TGUID = '{2B92470A-DC4F-4F8C-A45E-A66AA4CBDEA3}';
  DIID_IItlandWEvents: TGUID = '{95160112-0A24-4042-A5A3-C2BE94FC5B72}';
  CLASS_ItlandW: TGUID = '{DBCD9916-A5F2-4979-B296-376E87C05117}';
...
// *********************************************************************//
  IItlandW = interface;
  IItlandWDisp = dispinterface;
  IItlandWEvents = dispinterface;
...
// GUID:      {2B92470A-DC4F-4F8C-A45E-A66AA4CBDEA3}
// *********************************************************************//
  IItlandW = interface(IDispatch)
    ['{2B92470A-DC4F-4F8C-A45E-A66AA4CBDEA3}']
...
// *********************************************************************//
// DispIntf:  IItlandWEvents
// Flags:     (0)
// GUID:      {95160112-0A24-4042-A5A3-C2BE94FC5B72}
// *********************************************************************//
  IItlandWEvents = dispinterface
    ['{95160112-0A24-4042-A5A3-C2BE94FC5B72}']
...
// Control Name     : TItlandW
// Help String      : ItlandW Control
// Default Interface: IItlandW
// Def. Intf. DISP? : No
// Event   Interface: IItlandWEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TItlandWOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TItlandW = class(TOleControl)
  private
    ...
    FOnKeyPress: TItlandWOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IItlandW;
    function  GetControlInterface: IItlandW;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IItlandW read GetControlInterface;
    property  DefaultInterface: IItlandW read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TItlandWOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TItlandW.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{DBCD9916-A5F2-4979-B296-376E87C05117}';
    EventIID: '{95160112-0A24-4042-A5A3-C2BE94FC5B72}';
    EventCount: 8;
...
procedure TItlandW.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IItlandW;
  end;
...
function TItlandW.GetControlInterface: IItlandW;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TItlandW]);
end;
