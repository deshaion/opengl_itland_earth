...
// PASTLWTR : 1.2
// File generated on 24.07.2005 3:17:19 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Documents and Settings\Vanya\Мои документы\Работа\ITland\ITLandProj1.tlb (1)
// LIBID: {1E626EFE-C76C-4B7E-A67F-C0AD7C916902}
// LCID: 0
// Helpfile: 
// HelpString: ITLandProj1 Library
// DepndLst: 
...
const
  ...
  ITLandProj1MajorVersion = 1;
  ITLandProj1MinorVersion = 0;

  LIBID_ITLandProj1: TGUID = '{1E626EFE-C76C-4B7E-A67F-C0AD7C916902}';

  IID_IITLand: TGUID = '{76976620-0C6B-4E78-A09E-8A6BFFE4BE4E}';
  DIID_IITLandEvents: TGUID = '{1A5FE456-1422-4008-AEDA-9A855EA9F28C}';
  CLASS_ITLand: TGUID = '{09846FCE-0690-466B-9063-744A60FB3B22}';
...
// *********************************************************************//
  IITLand = interface;
  IITLandDisp = dispinterface;
  IITLandEvents = dispinterface;
...
// GUID:      {76976620-0C6B-4E78-A09E-8A6BFFE4BE4E}
// *********************************************************************//
  IITLand = interface(IDispatch)
    ['{76976620-0C6B-4E78-A09E-8A6BFFE4BE4E}']
...
// *********************************************************************//
// DispIntf:  IITLandEvents
// Flags:     (0)
// GUID:      {1A5FE456-1422-4008-AEDA-9A855EA9F28C}
// *********************************************************************//
  IITLandEvents = dispinterface
    ['{1A5FE456-1422-4008-AEDA-9A855EA9F28C}']
...
// Control Name     : TITLand
// Help String      : ITLand Control
// Default Interface: IITLand
// Def. Intf. DISP? : No
// Event   Interface: IITLandEvents
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TITLandOnKeyPress = procedure(ASender: TObject; var Key: Smallint) of object;

  TITLand = class(TOleControl)
  private
    ...
    FOnKeyPress: TITLandOnKeyPress;
    FOnPaint: TNotifyEvent;
    FIntf: IITLand;
    function  GetControlInterface: IITLand;
  protected
    procedure CreateControl;
    procedure InitControlData; override;
  public
    property  ControlInterface: IITLand read GetControlInterface;
    property  DefaultInterface: IITLand read GetControlInterface;
  ...
  published
    ...
    property OnKeyPress: TITLandOnKeyPress read FOnKeyPress write FOnKeyPress;
...
procedure TITLand.InitControlData;
const
  ...
  CControlData: TControlData2 = (
    ClassID: '{09846FCE-0690-466B-9063-744A60FB3B22}';
    EventIID: '{1A5FE456-1422-4008-AEDA-9A855EA9F28C}';
    EventCount: 8;
...
procedure TITLand.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IITLand;
  end;
...
function TITLand.GetControlInterface: IITLand;
begin
  CreateControl;
  Result := FIntf;
end;
...
procedure Register;
begin
  RegisterComponents(dtlOcxPage, [TITLand]);
end;
